---
title: "Analysis of ESPRESSO data (Stable 04.01.2016)"
...
file.path <- c("/Users/josesho/Desktop/scratch/ESPRESSO/R48B04-Hungry")
...
```{r LoadLibraries, message = FALSE, warning = FALSE, error=FALSE, echo = FALSE, eval = TRUE}
# For running Dunn's Test
library("dunn.test")
...
```{r RasterPlotFeedEvent, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 18, fig.fullwidth = TRUE, results = "hide"}
...
```{r CumSumDataPlot, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 20, fig.width = 15, fig.fullwidth = FALSE}
...
```{r CorrelateFeedDurationFeedVolume, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 18, fig.width = 15, fig.fullwidth = TRUE}
corr <- data.frame()
...
```{r CorrelateAverageFeedSizePerFly_TotalFeedCountPerFly, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 18, fig.width = 15, fig.fullwidth = TRUE}
corr <- data.frame()
...
```{r piPlot, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 18, fig.fullwidth = TRUE, results = "hide"}
...
```{r TimeCourse, message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 18, fig.fullwidth = TRUE, results = "hide"}
n <- paste("bin.", as.character(bw/60), ".min", sep = "")
...
```{r DensityDistributionFeedCount, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r feedCountKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, results = "hide", error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r DensityDistributionTotalVolumeIntake, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r VolumeIntakeKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25,  fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r DensityDistributionTimeToFirstFeed, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r TimeToFirstFeedKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25,  fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r DensityDistributionFeedSizePerFly, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r FeedSizePerFlyKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r FeedSizeSummaryPlot_And_Table, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 18, fig.width = 15, fig.fullwidth = TRUE}
a <- "mean.vol.per.feed.nanoliter" # from summary.per.fly
...
```{r FeedSizeKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {

    grid.arrange(table.noFood[["Average Feed Size (nl)"]], table.withFood[["Average Feed Size (nl)"]], 
                 nrow = 2, heights = c(0.5, 1.5),
...
```{r DensityDistributionFeedDuration, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r feedDurationKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25, fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r DensityDistributionFeedingSpeed, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 16, fig.width = 10, fig.fullwidth = TRUE}
plot.list <- list()
...
```{r feedingSpeedKruskalDunnTestHedgesG, message = FALSE, warning = FALSE, error = TRUE, echo = FALSE, eval = TRUE, fig.height = 25,  fig.width = 20, fig.fullwidth = TRUE}
if ( length(levels(rawdata.all[, "FoodIdx"])) > 1 ) {
...
```{r Comparison, message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, eval = FALSE, fig.height = 20, fig.width = 18, fig.fullwidth = TRUE}
